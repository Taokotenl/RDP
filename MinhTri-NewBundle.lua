...
["Senko-San"] = {
	...
	if load.IsLoaded == false then
		...
		if loadupClosed == false then
                ...
                GUIObject.Screen.Enabled = true
            --// =========================
--//  MODERN UI PATCH V7 - PUBLIC VERSION
...
do
    task.defer(function()
        ...
        local function buildMainUI()
            ...
            Search.Position = UDim2.new(0.60, 0, 0.5, 0)
            Search.Size = UDim2.new(0.46, 0, 0, 40)
            Search.ZIndex = 61
            mkCorner(Search, 12)
            ...
            if GUIObject.ButtonFrame and GUIObject.ButtonFrame:IsA("Frame") then
                GUIObject.ButtonFrame.Visible = false
            end
            ...
            local function makeScrollablePage(legacyPage)
                ...
                local function refresh()
                    task.defer(function()
                        ...
                        wrap.CanvasSize = UDim2.new(0, 0, 0, math.max(h + 18, wrap.AbsoluteSize.Y))
                    end)
                end
